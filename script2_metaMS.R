...
## This script was shared by Diego Salazar 
...
CDF_alk_dir <- "~/Desktop/dataprocessing/data/CDf_files"
CDF_alk_dir
...
write.csv(result_all_alk$PeakTable, file = "2_featuretable_metaMS_snthresh1.csv")
write.msp(all_alk_comp_spectra, file = "spectra_metaMS.msp") ### read this in the NIST search to identify individual compounds
